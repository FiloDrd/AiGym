...
import 'equipment_selection_model.dart';
export 'equipment_selection_model.dart';

class EquipmentSelectionWidget extends StatefulWidget {
  const EquipmentSelectionWidget({super.key});
...
class _EquipmentSelectionWidgetState extends State<EquipmentSelectionWidget> {
  late EquipmentSelectionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EquipmentSelectionModel());
  }
